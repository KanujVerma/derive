...
import {
  baselineAngles, deriveManagedUpgradeView, managedFieldLabels,
...
export function ManagedUpgradePresentation({
  ...
  return <ScrollView contentContainerStyle={styles.content}>
    ...
    {view.stage !== 'identity_required' && <>
      ...
      {view.stage === 'submitted_preparing' && <GroupedSection header="Submitted"><View style={styles.cardInner}><Text style={styles.body}>Your intake was submitted. Your managed plan is being prepared.</Text></View></GroupedSection>}
      {view.stage === 'active_managed' && <GroupedSection header="Managed plan active"><View style={styles.cardInner}><Text style={styles.body}>Your current routine and check-ins are available in Plan.</Text></View></GroupedSection>}
    </>}
  </ScrollView>;
}
