...
Every implementation milestone has one founder owner. This approved split supports long parallel work with minimal file overlap. Wave-1 foundations and local mobile/platform integration are landed. K-FREE-2 (#51), K-FREE-3 (#48), K-FREE-4 (#49), K-PAID-1A (#52), K4-COMPOSE handoff prep (#55), KPAID-COMPOSE (#56), and K2-COMPOSE (#60) are landed. S-FREE-2 (#54), S-FREE-3 (#58), and S-FREE-4 (#61) are merged into main as local platform contracts, but mobile integration and hosted deployment remain separate. [ROADMAP.md](ROADMAP.md) has the full sequence and acceptance gates.
...
- **K-FREE-2, LANDED (PR #51):** optional minimal personalization after factual first Check, same-result refresh and edit seams; fixture-backed. S-FREE-2 is merged; Kanuj owns the mobile service integration.
...
- **S-FREE-2 / Wave 2, LANDED (PR #54):** minimal free profile and deterministic categorical fit. The Retinyl Propionate pregnancy-fit defect has a regression fix and exact-head CI passed. No hosted deployment or mobile consumption. See [S_FREE_2_PERSONAL_FIT.md](S_FREE_2_PERSONAL_FIT.md).
- **S-FREE-3 / Wave 3, LANDED (PR #58):** owner-bound free Check history, shelf/product states, reactions/tolerance and profile context data plane, including anonymous ownership. Kanuj's UI remains fixture-backed until its service integration.
- **S-FREE-4 / Wave 4, LANDED (PR #61):** private grant-bound free product evidence, S6 candidate/formula resolution and review states, and managed Shelf separation. OCR/model output is not authoritative identity. Kanuj integration and hosted deployment remain separate; see [S_FREE_4_PRODUCT_EVIDENCE.md](S_FREE_4_PRODUCT_EVIDENCE.md).
...
| 2, platform/presentation landed | K-FREE-2 (PR #51), K2-COMPOSE (PR #60) / S-FREE-2 (PR #54) | Kanuj-owned mobile service integration remains separate. |
| 3, platform/presentation landed | K-FREE-3 (PR #48) / S-FREE-3 (PR #58) | Owner-bound persistence is merged; mobile reads/writes remain separate. |
| 4, platform/presentation landed | K-FREE-4 (PR #49) / S-FREE-4 (PR #61) | K4 handoff prep (PR #55) is landed; Kanuj owns capture-to-resolver integration. |
