...
Derive is a managed skincare service. Customers provide their observations, bathroom counter bottles, and skin history; Derive performs the interpretation, provides a canonical routine, answers questions, checks in weekly, and replenishes verified products.
...
4. **Contextual Ask Derive**: Uncapped answers grounded in their active products, retinoid schedule, and reaction history.
5. **Weekly Check-Ins & Progress**: Longitudinal tracking of tolerance, barrier stability, and photo comparison.
6. **Managed Refills**: 1-tap replenishment of standard products without automated depletion illusions.
