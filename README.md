...
Managed skincare membership ("Your skincare, handled"). Built on Apple-grade minimalism, contextual intelligence, and persistent customer care. The initial 10-member Founding Beta experiment is $25/month; products and refills are purchased separately with explicit price approval.
...
- **Commerce**: Planned trusted Stripe checkout for the $25/month Founding Beta membership plus a separate, consent-gated product purchase/refill flow. (Re-scoped S5 on the roadmap; not yet live.)
