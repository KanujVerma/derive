...
- C1 Shop work lives on draft branch `kanuj/c1-shop-v1` (5 member tabs: Today, Plan, Shop, Ask, Progress; no sixth tab). Physical commerce backend and live billing remain deferred to C1.5 / S5 reconciliation.
