...
- **C1.5A draft**: Shop-only trusted merchant listings and outbound Where to Buy for published ADD. C1.5B official feeds and C1.5C Derive Shopify checkout remain planned; no product Order schema or physical checkout. See `docs/COMMERCE.md` and ADR-32.
